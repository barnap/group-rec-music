...
# # This are Spotify API Credentials! Create another spotify account create an application!
# client_id = "41010c4a9f6a43bcb3020567fd134433"
# client_secret = "08f845357e0e49849e8e319c56ffd406"
#
# ADDRESS = "127.0.0.1"
# PORT = "5000"
# main_page_uri = "http://"+ADDRESS+":"+PORT
#
# # Below link must be added to spotify Application callback links through developer.spotify.account
# redirect_uri = main_page_uri+"/callback"
#
...
#     "MAIL_PASSWORD": 'tpemqaggeeeuvzbv',
#     # "MAIL_PASSWORD": 'GroupRec1986@',
#     "MAIL_DEFAULT_SENDER": 'grouprecexperiments@gmail.com'
# }
#
# TEST_MODE = False
# TRACK_TO_SELECT = 5
# ADMIN_USER_ID_LIST = ('11168569646',)
